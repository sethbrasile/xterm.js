...
class BaseRenderLayer {
    constructor(_container, id, zIndex, _alpha, _colors, _coreBrowserService) {
    ...
    _refreshCharAtlas(terminal, colorSet) {
        ...
        this._charAtlas = (0, CharAtlasCache_1.acquireCharAtlas)(terminal, colorSet, this._scaledCellWidth, this._scaledCellHeight, this._scaledCharWidth, this._scaledCharHeight, this._coreBrowserService.dpr);
    ...
    _fillBottomLineAtCells(x, y, width = 1) {
        this._ctx.fillRect(x * this._scaledCellWidth, (y + 1) * this._scaledCellHeight - this._coreBrowserService.dpr - 1, width * this._scaledCellWidth, this._coreBrowserService.dpr);
    }
    ...
    _strokeRectAtCell(x, y, width, height) {
        ...
        this._ctx.strokeRect(x * this._scaledCellWidth + this._coreBrowserService.dpr / 2, y * this._scaledCellHeight + (this._coreBrowserService.dpr / 2), width * this._scaledCellWidth - this._coreBrowserService.dpr, (height * this._scaledCellHeight) - this._coreBrowserService.dpr);
    }
    _clearAll() {
        if (this._alpha) {
    ...
    _clipCell(x, y, width) {
        this._ctx.beginPath();
        this._ctx.rect(x * this._scaledCellWidth, y * this._scaledCellHeight, width * this._scaledCellWidth, this._scaledCellHeight);
        this._ctx.clip();
    }
