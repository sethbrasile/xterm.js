...
class WebglRenderer extends Lifecycle_1.Disposable {
    constructor(_terminal, _colors, _characterJoinerService, _coreBrowserService, coreService, _decorationService, preserveDrawingBuffer) {
        ...
        this._renderLayers = [
            new LinkRenderLayer_1.LinkRenderLayer(this._core.screenElement, 2, this._colors, this._core, this._coreBrowserService),
    ...
    _refreshCharAtlas() {
        ...
        const atlas = (0, CharAtlasCache_1.acquireCharAtlas)(this._terminal, this._colors, this.dimensions.scaledCellWidth, this.dimensions.scaledCellHeight, this.dimensions.scaledCharWidth, this.dimensions.scaledCharHeight, this._coreBrowserService.dpr);
    ...
    renderRows(start, end) {
        if (!this._isAttached) {
            if (this._coreBrowserService.window.document.body.contains(this._core.screenElement) && this._core._charSizeService.width && this._core._charSizeService.height) {
                this._updateDimensions();
                this._refreshCharAtlas();
