...
class WebglCharAtlas {
    ...
    _drawToCache(codeOrChars, bg, fg, ext) {
        ...
        if (this._config.customGlyphs !== false) {
            customGlyph = (0, CustomGlyphs_1.tryDrawCustomChar)(this._tmpCtx, chars, padding, padding, this._config.scaledCellWidth, this._config.scaledCellHeight, this._config.fontSize, this._config.devicePixelRatio);
        }
