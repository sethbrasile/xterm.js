...
function acquireCharAtlas(terminal, colors, scaledCellWidth, scaledCellHeight, scaledCharWidth, scaledCharHeight, devicePixelRatio) {
    const newConfig = (0, CharAtlasUtils_1.generateConfig)(scaledCellWidth, scaledCellHeight, scaledCharWidth, scaledCharHeight, terminal, colors, devicePixelRatio);
