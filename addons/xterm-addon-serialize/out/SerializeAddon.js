...
class SerializeAddon {
    ...
    _serializeBufferAsHTML(terminal, options) {
        ...
        const onlySelection = (_a = options.onlySelection) !== null && _a !== void 0 ? _a : false;
        if (!onlySelection) {
            const maxRows = buffer.length;
        ...
        const selection = (_b = this._terminal) === null || _b === void 0 ? void 0 : _b.getSelectionPosition();
...
class HTMLSerializeHandler extends BaseSerializeHandler {
    constructor(buffer, _terminal, _options) {
        ...
        this._currentRow = '';
        this._htmlContent = '';
        this._colors = _terminal._core._colorManager.colors;
    }
    ...
    _beforeSerialize(rows, start, end) {
        ...
        if ((_a = this._options.includeGlobalBackground) !== null && _a !== void 0 ? _a : false) {
            foreground = (_c = (_b = this._terminal.options.theme) === null || _b === void 0 ? void 0 : _b.foreground) !== null && _c !== void 0 ? _c : '#ffffff';
            background = (_e = (_d = this._terminal.options.theme) === null || _d === void 0 ? void 0 : _d.background) !== null && _e !== void 0 ? _e : '#000000';
        }
