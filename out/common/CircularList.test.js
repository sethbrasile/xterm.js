...
describe('CircularList', () => {
    describe('push', () => {
        it('should push values onto the array', () => {
            const list = new CircularList_1.CircularList(5);
            list.push('1');
            list.push('2');
            list.push('3');
            list.push('4');
        ...
        it('should push old values from the start out of the array when max length is reached', () => {
            const list = new CircularList_1.CircularList(2);
            list.push('1');
            list.push('2');
            chai_1.assert.equal(list.get(0), '1');
            chai_1.assert.equal(list.get(1), '2');
    ...
    describe('splice', () => {
        ...
        it('should delete items then insert items', () => {
            const list = new CircularList_1.CircularList(3);
            list.push('1');
            list.push('2');
            list.splice(0, 1, '3', '4');
    ...
    describe('shiftElements', () => {
        ...
        it('should throw for invalid args', () => {
            const list = new CircularList_1.CircularList(5);
            list.push(1);
            chai_1.assert.throws(() => list.shiftElements(-1, 1, 1), 'start argument out of range');
            chai_1.assert.throws(() => list.shiftElements(1, 1, 1), 'start argument out of range');
            chai_1.assert.throws(() => list.shiftElements(0, 1, -1), 'Cannot shift elements in list beyond index 0');
        });
